...
| `mtf` | ✅ 稼働 | `strategy_mtf.py` (週/日/4H/1H 全軸トレンド一致 + 15M S/Aパターン。常時許可=4軸一致が内在ゲート) |
...
| MTF 全軸一致 | `strategy_mtf.py` (週/日/4H/1H `analyze_timeframe` 一致 + `patterns.detect` S/A)。週足は日足resample。`docs/MTF_METHOD.md` |
